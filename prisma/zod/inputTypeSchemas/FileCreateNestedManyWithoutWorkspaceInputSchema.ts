...
export const FileCreateNestedManyWithoutWorkspaceInputSchema: z.ZodType<Prisma.FileCreateNestedManyWithoutWorkspaceInput> = z.object({
...
export default FileCreateNestedManyWithoutWorkspaceInputSchema;
