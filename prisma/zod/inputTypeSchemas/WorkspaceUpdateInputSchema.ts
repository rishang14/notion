...
import { FolderUpdateManyWithoutWorkspaceNestedInputSchema } from './FolderUpdateManyWithoutWorkspaceNestedInputSchema';
import { FileUpdateManyWithoutWorkspaceNestedInputSchema } from './FileUpdateManyWithoutWorkspaceNestedInputSchema';
import { CollaboratorUpdateManyWithoutWorkspaceNestedInputSchema } from './CollaboratorUpdateManyWithoutWorkspaceNestedInputSchema';
...
export const WorkspaceUpdateInputSchema: z.ZodType<Prisma.WorkspaceUpdateInput> = z.object({
  ...
  folders: z.lazy(() => FolderUpdateManyWithoutWorkspaceNestedInputSchema).optional(),
  files: z.lazy(() => FileUpdateManyWithoutWorkspaceNestedInputSchema).optional(),
  collaborators: z.lazy(() => CollaboratorUpdateManyWithoutWorkspaceNestedInputSchema).optional()
}).strict();
