...
export const CollaboratorCreateNestedManyWithoutWorkspaceInputSchema: z.ZodType<Prisma.CollaboratorCreateNestedManyWithoutWorkspaceInput> = z.object({
...
export default CollaboratorCreateNestedManyWithoutWorkspaceInputSchema;
