...
export const SubscriptionUpdateWithoutPriceInputSchema: z.ZodType<Prisma.SubscriptionUpdateWithoutPriceInput> = z.object({
...
export default SubscriptionUpdateWithoutPriceInputSchema;
