...
export const FolderCreateNestedManyWithoutWorkspaceInputSchema: z.ZodType<Prisma.FolderCreateNestedManyWithoutWorkspaceInput> = z.object({
...
export default FolderCreateNestedManyWithoutWorkspaceInputSchema;
