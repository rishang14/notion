...
export const SubscriptionUncheckedCreateNestedManyWithoutPriceInputSchema: z.ZodType<Prisma.SubscriptionUncheckedCreateNestedManyWithoutPriceInput> = z.object({
...
export default SubscriptionUncheckedCreateNestedManyWithoutPriceInputSchema;
