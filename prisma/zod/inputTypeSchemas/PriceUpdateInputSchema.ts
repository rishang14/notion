...
import { ProductUpdateOneWithoutPricesNestedInputSchema } from './ProductUpdateOneWithoutPricesNestedInputSchema';
import { SubscriptionUpdateManyWithoutPriceNestedInputSchema } from './SubscriptionUpdateManyWithoutPriceNestedInputSchema';
...
export const PriceUpdateInputSchema: z.ZodType<Prisma.PriceUpdateInput> = z.object({
  ...
  product: z.lazy(() => ProductUpdateOneWithoutPricesNestedInputSchema).optional(),
  subscriptions: z.lazy(() => SubscriptionUpdateManyWithoutPriceNestedInputSchema).optional()
}).strict();

export default PriceUpdateInputSchema;
